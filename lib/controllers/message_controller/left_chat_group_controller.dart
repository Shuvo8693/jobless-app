...
class LeftChatGroupController extends GetxController {
  final ChatListController _chatListController=Get.put(ChatListController());
  RxString errorMessage = ''.obs;
  RxBool isLoading = false.obs;

  leftChatGroup(String groupId) async {
    try {
      ...
      var request = http.Request('POST', Uri.parse(ApiConstants.leaveGroupChatUrl));

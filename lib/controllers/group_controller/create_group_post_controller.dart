...
class GroupCreatePostController extends GetxController {
  RxString commentMessage = ''.obs;
  RxBool isLoading=false.obs;
  createGroupPost(String? content, String filePath,String privacy,dynamic groupId) async {
    ...
    var request =  http.MultipartRequest('POST', Uri.parse(ApiConstants.createGroupPostUrl));

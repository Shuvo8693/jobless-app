...
class CreateGroupController extends GetxController {
  ...
  createGroup(String name,description,{bool? isNavigateToCreateGroupMessageScreen=false }) async {
    try {
      ...
      var request = http.MultipartRequest('POST', Uri.parse(ApiConstants.createGroupUrl));
      ...
      if (response.statusCode == 201) {
        ...
        if(isNavigateToCreateGroupMessageScreen??false){

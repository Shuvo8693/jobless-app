...
class FriendInviteController extends GetxController {
  ...
  inviteFriend({required String friendId,required String groupId,Function()? toRemoveFromIndex}) async {
    try {
      ...
      var request = http.Request('POST', Uri.parse(ApiConstants.addGroupMemberUrl));

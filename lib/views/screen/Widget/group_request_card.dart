...
class GroupRequestCard extends StatelessWidget {
  ...
  GroupRequestCard({super.key,required this.onTab,this.buttonTitle,this.icon,required this.myGroupAttributes});
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading:CustomNetworkImage(
        imageUrl: "${ApiConstants.imageBaseUrl}${myGroupAttributes.coverImage}",
        height: 70.h,
        width: 64.w,
        borderRadius: BorderRadius.circular(10.r),
      ),
      title: Text("${myGroupAttributes.name}",style: AppStyles.customSize(size:14,fontWeight: FontWeight.w500,family: "Schuyler",),),
      subtitle: Row(
        ...
        children: [
          Row(
            children: [
              ...
              Text('${myGroupAttributes.privacy}',style: AppStyles.h6(color: AppColors.subTextColor)),
            ],
          ),
          CustomButton(
              width: 76.w,

              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: ()async {
                        await _profileUpdateCtrl.pickImageFromCameraToUpdateProfile(ImageSource.gallery);
                      },
                      child: SizedBox(
                        child: Column(
                          children: [
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () async{
                        await _profileUpdateCtrl.pickImageFromCameraToUpdateProfile(ImageSource.camera);
                      },
                      child: SizedBox(
                        child: Column(
                          children: [
